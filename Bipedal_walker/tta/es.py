...
class ESOptimizer:
    ...
    def evaluate_transfer(self, optimizers, evaluate_proposal=True, propose_with_adam=False):
        ...
        for source_optim in optimizers.values():
            ...
            logger.info(f"source_optim = {source_optim}, score = {score}, best_init_score = {best_init_score}")
            logger.info(f"best_init_score = {best_init_score}")
