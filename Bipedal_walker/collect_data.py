'''*************************************************************************
【文件名】                 collect_data.py
【功能模块和目的】         利用BipedalWalkerTest环境，对actions均匀采样或不利用action，记录每个episode的信息
...
for epoch in range(max_epoch):
    ...
    if epoch % 1000 == 0:
        ...
        """
        np.save(f'/mnt1/hyj/Acc_Test/tta_new/tta/data/raw_data_new/transitions_{epoch//1000}.npy',raw_data,allow_pickle=True)
        raw_data = []
