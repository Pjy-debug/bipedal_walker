...
class LunarLander_nde(gym.Env, EzPickle):
    """
    ## Description
    ...
    * The angular velocity is in units of 0.4 radians per second. In order to convert to radians per second, the value needs to be multiplied by a factor of 2.5.
    ...
    def reset(
        ...
        *,
        ...
        # Create Terrain
        CHUNKS = 5
        height = self.np_random.uniform(0, H / 2.5, size=(CHUNKS + 1,))
    ...
    def calcu_q(self,obs, cur_wind_mag, cur_torque_mag):
        ...
        outputs2 = self.criticality_model2(new_k_inputs)
    ...
    def get_env_action(self, obs, cur_wind_mag, cur_torque_mag):
        ...
        if weight > 1:
            print(weight,p_list[action_idx],pdf_array[action_idx],action_idx)
            print(pdf_array)
        #print('weight:',weight)
